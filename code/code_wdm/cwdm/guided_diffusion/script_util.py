...
def create_model(
    ...
    if use_cross_attention:
        from .cross_attention_unet import CrossAttentionUNet as _UNet
        
    else:
        from .unet import UNetModel as _UNet
    
    if not use_freq:
        return _UNet(
            in_ch=in_channels,
            cond_ch=in_channels*3,
            base_ch=num_channels,
